...
from ._utils import (
    ...
    get_html_body as _get_html_body,
    parse_decimal as _parse_decimal,
    parse_date as _parse_date,
    classify_asset as _classify_asset_util,
)
...
class FundEmailParser(StatementParser):
    ...
    def _parse_row(
        ...
        try:
            ...
            market, asset_type = _classify_asset_util(
                name, code, self._default_market, self._default_asset_type
            )
